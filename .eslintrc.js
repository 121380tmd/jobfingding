...
module.exports = {
  ...
  rules: {
    ...
    // 检查 data computed 中是否有重复值
    "vue/no-dupe-keys": [ "error", {
      "groups": [], // "groups" (string[]) Array of additional groups to search for duplicates. Default is empty.
    }],
    "vue/no-mutating-props": 2,
    "vue/require-name-property": 2, // This rule requires a name property to be set on components.
    // "vue/comma-spacing": 2,
    "comma-spacing": [ 2, {
      "before": false,
      "after": true,
